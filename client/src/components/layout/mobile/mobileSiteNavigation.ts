...
export const MOBILE_ROUTE_PATTERNS: MobileRoutePattern[] = [
  ...
  { key: "novel-auto-director", pattern: /^\/novels\/auto-director\/?$/, title: "AI 自动导演开书", group: "novels" },
  ...
  { key: "audiobook", pattern: /^\/audiobook\/?$/, title: "有声书工作台", group: "creation" },
  { key: "audiobook-voice-library", pattern: /^\/audiobook\/voice-library\/?$/, title: "有声书音色库", group: "creation" },
  { key: "audiobook-project", pattern: /^\/audiobook\/novels\/[^/]+\/?$/, title: "有声书开发", group: "creation" },
