import {
  createPromptAssetRegistry,
  type PromptAssetLoaderEntry,
  type UnknownPromptAsset,
} from "./core/PromptAssetRegistry";
...
const promptAssetLoaderEntries: PromptAssetLoaderEntry[] = [
  ...
  {
    key: "audiobook.voice.library_pick@v1",
    load: () => require("./prompts/audiobook/voiceLibraryPick.prompts").voiceLibraryPickPrompt as UnknownPromptAsset,
  },
  {
