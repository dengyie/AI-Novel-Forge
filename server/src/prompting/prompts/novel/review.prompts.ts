...
> = {
  ...
  render: (input, context) => [
    new SystemMessage([
      ...
      "7. 任务完成度看情节结果是否在正文中成立，不因未复述任务单/提纲措辞而误伤 engagement 或 coherence。",
      "",
      "【issues 要求】",
      ...
      "",
      "【质量要求】",
      "1. 重点关注：情节是否完成本章任务结果、是否有新推进、是否存在明显冗余、是否留下有效钩子。",
...
export const chapterRepairPrompt: PromptAsset<ChapterRepairPromptInput, string, string> = {
  ...
  render: (input, context) => [
    new SystemMessage([
      ...
      "5. 补义务/结果缺口时，用场景与动作让结果在情节中成立；禁止插入任务单条目、功能标签、验收清单或说明性点题句。",
      "",
      "【具体要求】",
