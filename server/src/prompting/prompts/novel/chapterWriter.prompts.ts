  ...
  render: (input, context) => {
    ...
    return [
      new SystemMessage([
        ...
        "3. obligation contract 中的「本章必须命中 / 必须触碰的伏笔 / 必须出场的角色 / 必须发生的目标变化」都是本章必达项，必须在正文中让读者可见；不要在正文里写出 must_hit_now、payoff_missing_progress 等内部标识。",
        ...
        "在生成正文前，先内部确认以下三点：",
        "(1) 结尾是否形成了新的悬念或钩子？",
        "(2) 义务合同中的必达项是否已在正文中可见兑现（不要输出内部 code）？",
