  ...
  return {
    ...
    render: (_input, context) => [
      new SystemMessage([
        ...
        "",
        "【对手面 / 主压迫源约束】",
        "primaryPressureSource 必须写成「聚焦具体小圈层」：具名 1-3 个主动对手 + 少数助威冷眼；并明确绝大多数人中立、旁观、不参与、不站队。",
        "对手是「某些人」，不是「所有人」、「全班/全年级/全校」、「集体站队」、「人情与秩序整体」、「舆论全体」、「全社会」或「全世界针对主角」这类抽象群体。",
        "禁止用「称重」或同义机械度量隐喻（把人当物过秤、定重量、克数、指标）概括压迫；压迫要落到具体人物的具名动作与可观察的代价上。",
        "相邻卷可以换对手圈层，但每卷仍须 focused-local（具体具名对手），不得用「把对手升级成全班/全校/集体/全社会」代替具名对手升级。",
        "",
        "【禁止事项】",
        "禁止脱离上下文自行发明大设定。",
        ...
        "禁止把对手面写成全班/全校/全年级/集体站队/人情与秩序整体/舆论全体/全社会或全世界针对主角的抽象群体。",
        "禁止用「称重」及同义机械度量隐喻概括压迫；压迫必须落到具名对手的动作与可观察代价。",
        "",
