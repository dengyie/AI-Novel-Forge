...
> = {
  ...
  render: (input, context) => [
    new SystemMessage([
      ...
      "3. 前/中段 beats 的压力执行必须保持 focused-local：落到具名 1-3 个主动对手的具体动作与可观察代价上，明确绝大多数人中立、旁观、不站队；不得把 primaryPressureSource 放大成全班/全校/全年级/集体站队/人情与秩序整体/舆论全体或全社会针对主角的抽象群体升级。",
      "4. 中段必须体现 midVolumeRisk 或等价的局面转向，不能只是线性加码。",
      "5. climax beat 必须承接卷高潮承诺，形成明确兑现。",
      "6. 结尾 beat 必须承接 nextVolumeHook，并通过 resetPoint 或残局重组形成下一卷入口。",
      "",
      "【质量要求】",
