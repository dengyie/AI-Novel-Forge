  ...
  const response = await llm.invoke([
    {
      ...
      content: [
        ...
        "intent 必须是枚举值之一：query_novel_title, query_chapter_content, query_progress, inspect_failure_reason, write_chapter, rewrite_chapter, save_chapter_draft, start_pipeline, inspect_characters, inspect_timeline, inspect_world, search_knowledge, general_chat, unknown。",
