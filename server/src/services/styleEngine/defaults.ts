...
export const DEFAULT_ANTI_AI_RULES: DefaultAntiAiRuleDefinition[] = [
  {
    ...
    type: "forbidden",
    severity: "high",
    description: "禁止直接使用“他感到”“他意识到”“他知道”等句式解释人物心理或全知旁白。",
    detectPatterns: ["他感到", "她感到", "他意识到", "她意识到", "他明白了", "她明白了", "他知道", "她知道", "他清楚", "他心里清楚", "他心想"],
    rewriteSuggestion: "把心理解释改成动作、语气、停顿、环境反应或结果；把“他知道…”全知旁白改成具体的察觉过程。",
    promptInstruction: "禁止直接解释人物心理，人物状态必须通过行为、动作、语气或环境反应体现；避免“他知道…”式全知旁白，改为具体的察觉过程。",
    autoRewrite: true,
    enabled: true,
  ...
  {
    key: "risk-breath-driven-transition",
    name: "呼吸驱动情绪转折",
    type: "risk",
    severity: "medium",
    description: "反复用“深吸一口气”“吐出一口气”驱动情绪转折，是 AI 网文高频套路。",
    detectPatterns: ["深吸一口气", "深吸了一口气", "吐出一口气", "缓缓吐出", "深吸口气"],
    rewriteSuggestion: "把呼吸调节改成具体动作、视线转移、手部小动作或环境反应。",
    promptInstruction: "情绪转折不要靠“深吸一口气”这类呼吸描写驱动，用动作停顿、视线转移或手部小动作替代。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
  {
    ...
    type: "risk",
    severity: "high",
    description: "段尾用“凝练短句+预兆定格”堆叠制造戏剧感，是 AI 收章八股。",
    detectPatterns: [],
    rewriteSuggestion: "收尾落回具体动作、未完成的对话或被打断的处境，不要定格式渲染。",
    promptInstruction: "段尾禁止用“凝练短句+预兆定格”堆叠制造戏剧感；收尾必须落回具体动作、未完对话或被打断的处境。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
  {
    ...
    type: "risk",
    severity: "medium",
    description: "“微微/缓缓/渐渐/轻轻”等弱化副词高频复用，削弱动作力度，是 AI 文体特征。",
    detectPatterns: [],
    rewriteSuggestion: "删掉弱化副词，直接写动作强度；同段同类副词不超过两次。",
    promptInstruction: "限制“微微/缓缓/渐渐/轻轻”等弱化副词，直接写动作强度；同一段落同类副词不超过两次。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
  {
    key: "risk-simile-overuse",
    name: "比喻过密且工整",
    type: "risk",
    severity: "medium",
    description: "“像是/仿佛/宛如”比喻每段都套，且比喻工整无偏差，缺乏人味。",
    detectPatterns: [],
    rewriteSuggestion: "比喻要粗糙、私人、有偏差；避免每段都用明喻，比喻句式不重复。",
    promptInstruction: "比喻要粗糙、私人、有偏差；避免“像是/仿佛/宛如”每段都套，比喻句式不重复。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
  {
    key: "risk-rule-of-three",
    name: "强行三段排比",
    type: "risk",
    severity: "medium",
    description: "把想法强行凑成三项并列或三段排比来制造“全面感”，是 AI 结构套路。",
    detectPatterns: [],
    rewriteSuggestion: "打散三项并列，按真实主次展开，不凑数。",
    promptInstruction: "避免强行三段排比或三项并列来凑“全面感”，按真实主次自然展开。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
  {
    key: "risk-elegant-variation",
    name: "指代循环换称",
    type: "risk",
    severity: "medium",
    description: "同一人物在“主角/少年/他/男人”之间循环换称，是 AI 避重复的机械行为。",
    detectPatterns: [],
    rewriteSuggestion: "同一人物指代自然即可，不必为避重复循环换称呼。",
    promptInstruction: "同一人物避免在“主角/少年/他/男人”等称呼间循环换用，指代自然即可。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
  {
    key: "risk-authority-trope",
    name: "权威腔空转",
    type: "risk",
    severity: "low",
  ...
  {
    key: "risk-punctuation-driven-emotion",
    name: "标点驱动情绪",
    type: "risk",
    severity: "low",
    description: "破折号、省略号每段依赖来拖长或制造停顿，情绪靠标点而非白描。",
    detectPatterns: [],
    rewriteSuggestion: "破折号/省略号仅在真需要拖长或停顿时用，情绪靠动作和白描承载。",
    promptInstruction: "破折号、省略号仅在真需要拖长或停顿时用，避免每段依赖标点驱动情绪。",
    autoRewrite: false,
    enabled: true,
    globalBaselineEnabled: true,
  },
