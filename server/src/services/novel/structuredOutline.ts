...
export function buildStructuredOutlineSystemPrompt(totalChapters: number): string {
...
export function buildStructuredOutlineRepairSystemPrompt(totalChapters: number): string {
